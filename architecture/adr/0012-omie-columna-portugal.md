...
**Estado:** Corregido en la web (columna y versiones `.2`/`.3`), en la base y en el sistema Python local (columna y calendario de periodos) (2026-09-15). Pendiente: cuantificar el impacto en € y el desfase del cron (ver Alcance).
