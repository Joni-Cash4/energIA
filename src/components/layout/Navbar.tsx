...
function Ticker() {
  ...
  // Altura fija reservada desde el primer render: si esto devolviera null mientras
  // carga el fetch, el bloque aparecería de golpe y empujaría todo lo de abajo (CLS).
  if (!data) {
    return (
      <div className="w-full bg-[#0D0D0D] border-b border-[#1A1A1A] py-1.5 px-4 h-[30px]" aria-hidden="true" />
    )
  }
  ...
  return (
    <div className="w-full bg-[#0D0D0D] border-b border-[#1A1A1A] py-1.5 px-4 h-[30px] text-xs text-[#9CA3AF] flex items-center justify-center gap-1 overflow-hidden">
