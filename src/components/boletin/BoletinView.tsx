...
export function BoletinView({ initialStart }: { initialStart?: string }) {
  ...
  useEffect(() => { load(initialStart) }, [initialStart])
        ...
        <div className="max-w-6xl mx-auto py-10">
          ...
          {data && (
            <div className="flex flex-wrap items-center gap-3 mb-8">
              ...
              <select
                value={semana}
                onChange={(e) => router.push(`/noticias/boletin/${e.target.value}`)}
